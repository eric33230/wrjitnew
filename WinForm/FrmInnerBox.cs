...
namespace WinForm
{
    public partial class FrmInnerBox : Form
    {
        static FrmInnerBox frm = null;
        public static FrmInnerBox GetSingleton()
        {
    ...
    //    InnerboxBLL Innerbox = new InnerboxBLL();
        ...
        private void btnInterBoxImpro_Click(object sender, EventArgs e)
        {
            ...
            string[] sheetnames= Innerbox.getExcelSheetName(filename);
        ...
        private void dvgInnerBox_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
